...
namespace CILantro.Engine.Parser.CILASTBuilder
{
    ...
    {
        private readonly CILASTAddInstructionNodeBuilder _addInstructionNodeBuilder;
        ...
        {
            _addInstructionNodeBuilder = new CILASTAddInstructionNodeBuilder();
        ...
        {
            var addInstructionParseNode = parseNode.ChildNodes.FirstOrDefault(cn => cn.IsAddInstructionNode());
            if (addInstructionParseNode != null)
                return _addInstructionNodeBuilder.BuildNode(addInstructionParseNode);
            ...
            var loadInt32InstructionParseNode = parseNode.ChildNodes.FirstOrDefault(cn => cn.IsLoadInt32InstructionNode());
            if (loadInt32InstructionParseNode != null)
                return _loadInt32InstructionNodeBuilder.BuildNode(loadInt32InstructionParseNode);
            ...
            var loadInt32M1InstructionParseNode = parseNode.ChildNodes.FirstOrDefault(cn => cn.IsLoadInt32M1InstructionNode());
            if (loadInt32M1InstructionParseNode != null)
                return _loadInt32InstructionNodeBuilder.BuildNode(loadInt32M1InstructionParseNode);

            var loadInt32SInstructionParseNode = parseNode.ChildNodes.FirstOrDefault(cn => cn.IsLoadInt32SInstructionNode());
            if (loadInt32SInstructionParseNode != null)
                return _loadInt32InstructionNodeBuilder.BuildNode(loadInt32SInstructionParseNode);
