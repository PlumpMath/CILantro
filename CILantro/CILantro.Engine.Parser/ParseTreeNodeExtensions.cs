...
namespace CILantro.Engine.Parser
{
    public static class ParseTreeNodeExtensions
    {
        ...
        public static bool IsLoadInt324InstructionNode(this ParseTreeNode node)
        {
            return node.Term.Name.Equals("ldci44Instruction");
        }

        public static bool IsLoadInt325InstructionNode(this ParseTreeNode node)
        {
            return node.Term.Name.Equals("ldci45Instruction");
        }

        public static bool IsLoadInt326InstructionNode(this ParseTreeNode node)
        {
            return node.Term.Name.Equals("ldci46Instruction");
        }

        public static bool IsLoadInt327InstructionNode(this ParseTreeNode node)
        {
            return node.Term.Name.Equals("ldci47Instruction");
        }

        public static bool IsLoadInt328InstructionNode(this ParseTreeNode node)
        {
            return node.Term.Name.Equals("ldci48Instruction");
        }

        public static bool IsLoadInt32M1InstructionNode(this ParseTreeNode node)
        {
            return node.Term.Name.Equals("ldci4m1Instruction");
        }

        public static bool IsLoadInt32SInstructionNode(this ParseTreeNode node)
        {
        ...
        public static bool IsInt32ValueNode(this ParseTreeNode node)
        {
            return node.Term.Name.Equals("int32Value");
        }

        public static bool IsLoadInt32InstructionNode(this ParseTreeNode node)
        {
            return node.Term.Name.Equals("ldci4Instruction");
        }

        public static bool IsAddInstructionNode(this ParseTreeNode node)
        {
            return node.Term.Name.Equals("addInstruction");
        }
    }
}
